<%@ Page Title="R.E.M.O.T.O." Language="C#" MasterPageFile="~/Presentacion/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="UnidadesPromedioTrimXBrickMercado.aspx.cs" Inherits="PFIZER_FFVV.Presentacion.Vista.Trimestre.UnidadesPromedioTrimXBrickMercado" %>
...
<fieldset style="width:760px; height:auto; margin-left:15%; left: 200px; position: relative; top: -330px;">

      <legend>Trimestre/ Unid TrimXBrickMercado</legend> 
        ...
        <td valign="top">
          <asp:GridView ID="GridView1" AllowSorting="True" AllowPaging="True" runat="server"
            ...
            <Columns>
              ...
              <asp:BoundField DataField="TRIM_TOTAL" HeaderText="Total Unid" ReadOnly="True" SortExpression="TRIM_TOTAL" DataFormatString="{0:N0}" />
            </Columns>
          ...
          <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnPFIZER %>" SelectCommand="UnidadesTrimXBrickMercadoTotal" SelectCommandType="StoredProcedure" >
            <SelectParameters>
        ...
        <td>
              <asp:GridView runat="server" DataKeyNames="MERCADO" AutoGenerateRows="False" DataSourceID="SqlDataSource3" 
                  ...
                  <Columns>
                      ...
                      <asp:BoundField DataField="TRIM_TOTAL" HeaderText="Unid Total Trim x Brick Mercado" ReadOnly="True" SortExpression="TRIM_TOTAL" DataFormatString="{0:N0}" />
                  </Columns>
                  <FooterStyle BackColor="#ff9933" />
                  <HeaderStyle BackColor="#ff6600" Font-Bold="True" ForeColor="White" />
                  <PagerStyle BackColor="#ff9933" ForeColor="Black" HorizontalAlign="Right" />
              ...
              <asp:SqlDataSource runat="server" ConnectionString="<%$ ConnectionStrings:ConnPFIZER %>" SelectCommand="UnidadesTrimXBrickMercadoPeriodo" ID="SqlDataSource3" SelectCommandType="StoredProcedure">
                  <SelectParameters>
