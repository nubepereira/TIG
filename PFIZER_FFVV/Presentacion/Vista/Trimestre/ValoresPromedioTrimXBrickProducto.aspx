<%@ Page Title="R.E.M.O.T.O." Language="C#" MasterPageFile="~/Presentacion/MasterPage/Site3.Master" AutoEventWireup="true" CodeBehind="ValoresPromedioTrimXBrickProducto.aspx.cs" Inherits="PFIZER_FFVV.Presentacion.Vista.Trimestre.ValoresPromedioTrimXBrickProducto" %>
...
<fieldset style="width:700px; height:auto; margin-left:15%; left: 200px; position: relative; top: -330px;">
      ...
      <legend>Trimestre/ Valores TrimXBrickProducto</legend> 
   ...
   <table style="top: 0px; position:relative; left: 10px;">
      <tr>
        ...
        <td valign="top">
          ...
          <asp:GridView ID="GridView1" AllowSorting="True" AllowPaging="True" runat="server"
            ...
            <Columns>
              ...
              <asp:BoundField DataField="TOTAL_TRIM" HeaderText="Total Valores." SortExpression="TOTAL_TRIM" DataFormatString="{0:N0}" />
            </Columns>
          ...
          <asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="ValoresTrimXBrickMercadoXProductoTotal"
            ConnectionString="<%$ ConnectionStrings:ConnPFIZER %>" SelectCommandType="StoredProcedure">
            <SelectParameters>
        ...
        <td valign="top" style="width:250px">
            ...
            HeaderText="Detalle Periodos" ID="GridView2" Width="410px" AutoGenerateColumns="False" AllowPaging="True" style="left: 15px; position: relative; top: 0px; text-align: center;" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" PageSize="100">
            <AlternatingRowStyle BackColor="White" />
               <Columns>
                 <asp:BoundField DataField="MERCADO" HeaderText="Mercado" ReadOnly="True" SortExpression="MERCADO" Visible="false" />
                 ...
                 <asp:BoundField DataField="TRIM_PRODUCTO" HeaderText="Valores Trim x Brick Producto" ReadOnly="True" SortExpression="TRIM_PRODUCTO" DataFormatString="{0:N0}" />
               </Columns>
                   <FooterStyle BackColor="#ff9933" />
                  <HeaderStyle BackColor="#ff6600" Font-Bold="True" ForeColor="White" />
                  <PagerStyle BackColor="#ff9933" ForeColor="Black" HorizontalAlign="Right" />
            ...
            <asp:SqlDataSource runat="server" ConnectionString="<%$ ConnectionStrings:ConnPFIZER %>" SelectCommand="ValoresTrimXBrickMercadoXProductoPeriodo" ID="SqlDataSource3" SelectCommandType="StoredProcedure">
               <SelectParameters>
