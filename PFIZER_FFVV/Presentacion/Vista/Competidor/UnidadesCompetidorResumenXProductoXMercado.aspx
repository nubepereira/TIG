<%@ Page Title="R.E.M.O.T.O." Language="C#" MasterPageFile="~/Presentacion/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="UnidadesCompetidorResumenXProductoXMercado.aspx.cs" Inherits="PFIZER_FFVV.Presentacion.Vista.Competidor.UnidadesCompetidorResumenXProductoXMercado" %>
...
<fieldset style="width:373px; height:auto; margin-left:15%; left: 200px; position: relative; top: -190px;">
      <legend>Competidores/ Unid Resumen x Producto x Mercado</legend> 
    ...
    <table style="top: 0px; position:relative; left: 10px;">
      <tr>
        ...
        <td valign="top">
          ...
          <asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="UnidadesCompetidorResumen"
            ConnectionString="<%$ ConnectionStrings:ConnPFIZER %>" SelectCommandType="StoredProcedure">
            <SelectParameters>
