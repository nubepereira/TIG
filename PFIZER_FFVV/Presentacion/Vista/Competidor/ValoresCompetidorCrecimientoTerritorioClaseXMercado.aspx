<%@ Page Title="R.E.M.O.T.O." Language="C#" MasterPageFile="~/Presentacion/MasterPage/Site3.Master" AutoEventWireup="true" CodeBehind="ValoresCompetidorCrecimientoTerritorioClaseXMercado.aspx.cs" Inherits="PFIZER_FFVV.Presentacion.Vista.Competidor.ValoresCompetidorCrecimientoTerritorioClaseXMercado" %>
...
<legend>Competidores/ Valores Crecimiento Territorio Clase X Mercado</legend> 
    ...
    <table style="top: 0px; position:relative; left: 10px;">
      <tr>
       ...
       <td valign="top">
          ...
          <asp:GridView ID="GridView1" AllowSorting="True" AllowPaging="True" runat="server"
            ...
            <AlternatingRowStyle BackColor="White" />
                <Columns>
                  ...
                  <asp:BoundField DataField="CR" HeaderText="Valores Crecimiento Territorio Clase" SortExpression="CR" />
                </Columns>
          ...
          <asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="ValoresCompetidorCrecimientoTerritorioClaseXMercadoTotal"
            ConnectionString="<%$ ConnectionStrings:ConnPFIZER %>" SelectCommandType="StoredProcedure">
            <SelectParameters>
        ...
        <td valign="top" style="width:250px">
            ...
            <AlternatingRowStyle BackColor="White" />
               <Columns>
                 ...
                 <asp:BoundField DataField="CR_CRECIMIENTO" HeaderText="Valores Crecimiento Territorio Clase" ReadOnly="True" SortExpression="CR_CRECIMIENTO"  />
               </Columns>
                  <FooterStyle BackColor="#ff9933" />
                  <HeaderStyle BackColor="#ff6600" Font-Bold="True" ForeColor="White" />
                  <PagerStyle BackColor="#ff9933" ForeColor="Black" HorizontalAlign="Right" />
            ...
            <asp:SqlDataSource runat="server" ConnectionString="<%$ ConnectionStrings:ConnPFIZER %>" SelectCommand="ValoresCompetidorCrecimientoTerritorioClaseXMercadoPeriodo" ID="SqlDataSource3" SelectCommandType="StoredProcedure">
               <SelectParameters>
