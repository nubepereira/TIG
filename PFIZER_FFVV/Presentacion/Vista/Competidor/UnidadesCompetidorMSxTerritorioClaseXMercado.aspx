<%@ Page Title="R.E.M.O.T.O." Language="C#" MasterPageFile="~/Presentacion/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="UnidadesCompetidorMSxTerritorioClaseXMercado.aspx.cs" Inherits="PFIZER_FFVV.Presentacion.Vista.Competidor.UnidadesCompetidorMSxTerritorioClaseXMercado" %>
...
<fieldset style="width:700px; height:auto; margin-left:15%; left: 200px; position: relative; top: -330px;">
      <legend>Competidores/ Unid. MS% Territorio Clase X Mercado</legend> 
    ...
    <table style="top: 0px; position:relative; left: 10px;">
      <tr>
       ...
       <td valign="top">
          ...
          <asp:GridView ID="GridView1" AllowSorting="True" AllowPaging="True" runat="server"
            ...
            <AlternatingRowStyle BackColor="White" />
                <Columns>
                  ...
                  <asp:BoundField DataField="MS_COMPETIDORES" HeaderText="Unid. MS% Territorio Clase" SortExpression="MS_COMPETIDORES" />
                </Columns>
          ...
          <asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="UnidadesCompetidorMSxTerritorioClaseXMercadoTotal"
            ConnectionString="<%$ ConnectionStrings:ConnPFIZER %>" SelectCommandType="StoredProcedure">
            <SelectParameters>
        ...
        <td valign="top" style="width:250px">
            ...
            <AlternatingRowStyle BackColor="White" />
               <Columns>
                 ...
                 <asp:BoundField DataField="MS_COMPETIDORES" HeaderText="Unid ms% Territorio Clase" ReadOnly="True" SortExpression="MS_COMPETIDORES" />
               </Columns>
                  <FooterStyle BackColor="#ff9933" />
                  <HeaderStyle BackColor="#ff6600" Font-Bold="True" ForeColor="White" />
                  <PagerStyle BackColor="#ff9933" ForeColor="Black" HorizontalAlign="Right" />
            ...
            <asp:SqlDataSource runat="server" ConnectionString="<%$ ConnectionStrings:ConnPFIZER %>" SelectCommand="UnidadesCompetidorMSxTerritorioClaseXMercadoPeriodo" ID="SqlDataSource3" SelectCommandType="StoredProcedure">
               <SelectParameters>
