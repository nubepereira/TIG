<%@ Page Title="R.E.M.O.T.O." Language="C#" MasterPageFile="~/Presentacion/MasterPage/Site3.Master" AutoEventWireup="true" CodeBehind="ValoresCompetidorIExTerritorioClaseXMercado.aspx.cs" Inherits="PFIZER_FFVV.Presentacion.Vista.Competidor.ValoresCompetidorIExTerritorioClaseXMercado" %>
...
<legend>Competidores/ Valores IE% Territorio Clase X Mercado</legend> 
    ...
    <table style="top: 0px; position:relative; left: 10px;">
      <tr>
       ...
       <td valign="top">
          ...
          <asp:GridView ID="GridView1" AllowSorting="True" AllowPaging="True" runat="server"
            ...
            <AlternatingRowStyle BackColor="White" />
                <Columns>
                  ...
                  <asp:BoundField DataField="IE" HeaderText="Valores Crecimiento Territorio Clase" SortExpression="CR" />
                </Columns>
          ...
          <asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="ValoresCompetidoresIExTerritorioClaseXMercadoTotal"
            ConnectionString="<%$ ConnectionStrings:ConnPFIZER %>" SelectCommandType="StoredProcedure">
            <SelectParameters>
        ...
        <td valign="top" style="width:250px">
            ...
            <AlternatingRowStyle BackColor="White" />
               <Columns>
                 ...
                 <asp:BoundField DataField="IE" HeaderText="Valores Crecimiento Territorio Clase" ReadOnly="True" SortExpression="CR_CRECIMIENTO" />
               </Columns>
                  <FooterStyle BackColor="#ff9933" />
                  <HeaderStyle BackColor="#ff6600" Font-Bold="True" ForeColor="White" />
                  <PagerStyle BackColor="#ff9933" ForeColor="Black" HorizontalAlign="Right" />
            ...
            <asp:SqlDataSource runat="server" ConnectionString="<%$ ConnectionStrings:ConnPFIZER %>" SelectCommand="ValoresCompetidoresIExTerritorioClaseXMercadoPeriodo" ID="SqlDataSource3" SelectCommandType="StoredProcedure">
               <SelectParameters>
