<%@ Page Title="R.E.M.O.T.O." Language="C#" MasterPageFile="~/Presentacion/MasterPage/Site3.Master" AutoEventWireup="true" CodeBehind="ValoresRegionMercado.aspx.cs" Inherits="PFIZER_FFVV.Presentacion.Vista.Region.ValoresRegionMercado" %>
        ...
        <td valign="top">
          ...
          <asp:GridView ID="GridView1" AllowSorting="True" AllowPaging="True" runat="server"
            ...
            <Columns>
              ...
              <asp:BoundField DataField="TOTAL" HeaderText="Valores Total Mercado" SortExpression="TOTAL" DataFormatString="{0:N0}" />
            </Columns>
          ...
          <asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="ValoresRegionMercadoTotal"
            ConnectionString="<%$ ConnectionStrings:ConnPFIZER %>" SelectCommandType="StoredProcedure">
            <SelectParameters>
        ...
        <td valign="top" style="width:250px">
            ...
            <AlternatingRowStyle BackColor="White" />
               <Columns>
                 ...
                 <asp:BoundField DataField="TOTAL" HeaderText="Valores Region X Mercado" ReadOnly="True" SortExpression="TOTAL" DataFormatString="{0:N0}" />
               </Columns>
                   <FooterStyle BackColor="#ff9933" />
                  <HeaderStyle BackColor="#ff6600" Font-Bold="True" ForeColor="White" />
                  <PagerStyle BackColor="#ff9933" ForeColor="Black" HorizontalAlign="Right" />
            ...
            <asp:SqlDataSource runat="server" ConnectionString="<%$ ConnectionStrings:ConnPFIZER %>" SelectCommand="ValoresRegionMercadoPeriodo" ID="SqlDataSource3" SelectCommandType="StoredProcedure">
               <SelectParameters>
