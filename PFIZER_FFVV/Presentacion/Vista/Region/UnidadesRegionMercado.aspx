<%@ Page Title="R.E.M.O.T.O." Language="C#" MasterPageFile="~/Presentacion/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="UnidadesRegionMercado.aspx.cs" Inherits="PFIZER_FFVV.Presentacion.Vista.Region.UnidadesRegionMercado" %>
...
<fieldset style="width:600px; height:auto; margin-left:15%; left: 200px; position: relative; top: -330px;">
      ...
      <legend>Region/ Unid Mercado Region</legend> 
      ...
      <tr>
        ...
        <td valign="top">
          ...
          <asp:GridView ID="GridView1" AllowSorting="True" AllowPaging="True" runat="server"
            DataSourceID="SqlDataSource1" DataKeyNames="REGION"
            ...
            <Columns>
              ...
              <asp:BoundField DataField="TOTAL" HeaderText="Unid. Total Mercado" SortExpression="TOTAL" DataFormatString="{0:N0}" />
            </Columns>
          ...
          <asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="UnidadesRegionMercadoTotal"
            ConnectionString="<%$ ConnectionStrings:ConnPFIZER %>" SelectCommandType="StoredProcedure">
            <SelectParameters>
        ...
        <td valign="top" style="width:250px">
            <br />
            <asp:GridView runat="server" DataKeyNames="REGION" AutoGenerateRows="False" DataSourceID="SqlDataSource3" 
            ...
            <AlternatingRowStyle BackColor="White" />
               <Columns>
                 ...
                 <asp:BoundField DataField="TOTAL" HeaderText="Unid Region X Mercado" ReadOnly="True" SortExpression="TOTAL" DataFormatString="{0:N0}" />
               </Columns>
                   <FooterStyle BackColor="#ff9933" />
                  <HeaderStyle BackColor="#ff6600" Font-Bold="True" ForeColor="White" />
                  <PagerStyle BackColor="#ff9933" ForeColor="Black" HorizontalAlign="Right" />
            ...
            <asp:SqlDataSource runat="server" ConnectionString="<%$ ConnectionStrings:ConnPFIZER %>" SelectCommand="UnidadesRegionMercadoPeriodo" ID="SqlDataSource3" SelectCommandType="StoredProcedure">
               <SelectParameters>
