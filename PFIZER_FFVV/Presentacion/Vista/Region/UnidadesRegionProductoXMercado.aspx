<%@ Page Title="R.E.M.O.T.O." Language="C#" MasterPageFile="~/Presentacion/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="UnidadesRegionProductoXMercado.aspx.cs" Inherits="PFIZER_FFVV.Presentacion.Vista.Region.UnidadesRegionProductoXMercado" %>
...
<fieldset style="width:700px; height:auto; margin-left:15%; left: 200px; position: relative; top: -330px;">
      ...
      <legend>Region/ Unid. Region Producto X Mercado </legend> 
      ...
      <tr>
        ...
        <tr>
          <td valign="top">
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" SelectCommand="ProductoXMercadoXPeriodo"
              ConnectionString="<%$ ConnectionStrings:ConnPFIZER %>" SelectCommandType="StoredProcedure" >
                <SelectParameters>
        ...
        <td valign="top">
          ...
          <asp:SqlDataSource ID="SqlDataSource3" runat="server" SelectCommand="UnidadesRegionProductoXMercadoTotal"
            ConnectionString="<%$ ConnectionStrings:ConnPFIZER %>" SelectCommandType="StoredProcedure">
            <SelectParameters>
              <asp:ControlParameter ControlID="DropDownList1" Name="mercado" PropertyName="SelectedValue" Type="String" />
              <asp:SessionParameter Name="periodo" SessionField="SesionUsuarioPeriodo" Type="String" />
        ...
        <td valign="top" style="width:250px">
            ...
            <AlternatingRowStyle BackColor="White" />
               <Columns>
                 ...
                 <asp:BoundField DataField="TOTAL" HeaderText="Unid Region X Producto en el Mercado" ReadOnly="True" SortExpression="TOTAL" DataFormatString="{0:N0}" />
               </Columns>
                   <FooterStyle BackColor="#ff9933" />
                  <HeaderStyle BackColor="#ff6600" Font-Bold="True" ForeColor="White" />
                  <PagerStyle BackColor="#ff9933" ForeColor="Black" HorizontalAlign="Right" />
            ...
            <asp:SqlDataSource runat="server" ConnectionString="<%$ ConnectionStrings:ConnPFIZER %>" SelectCommand="UnidadesRegionProductoXMercadoPeriodo" ID="SqlDataSource4" SelectCommandType="StoredProcedure">
               <SelectParameters>
                  <asp:ControlParameter ControlID="DropDownList1" Name="mercado" PropertyName="SelectedValue" Type="String" />
                  <asp:SessionParameter Name="periodo" SessionField="SesionUsuarioPeriodo" Type="String" />
                  <asp:ControlParameter ControlID="DropDownList2" Name="producto" PropertyName="SelectedValue" Type="String" />
