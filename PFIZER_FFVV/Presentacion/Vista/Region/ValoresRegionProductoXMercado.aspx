<%@ Page Title="R.E.M.O.T.O." Language="C#" MasterPageFile="~/Presentacion/MasterPage/Site3.Master" AutoEventWireup="true" CodeBehind="ValoresRegionProductoXMercado.aspx.cs" Inherits="PFIZER_FFVV.Presentacion.Vista.Region.ValoresRegionProductoXMercado" %>
...
<fieldset style="width:700px; height:auto; margin-left:15%; left: 200px; position: relative; top: -190px;">
      ...
      <legend>Region/ Valores Region Producto X Mercado </legend> 
   ...
   <table style="top: 0px; position:relative; left: 10px;">
      <tr>
        ...
        <tr>
          <td valign="top">
             <b>Seleccione el Producto: </b>&nbsp;<asp:DropDownList ID="DropDownList2" DataSourceID="SqlDataSource2" AutoPostBack="true"
              DataTextField="PRODUCTO" runat="server" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged" AppendDataBoundItems="True" >
                <asp:ListItem Value="0">Seleccione</asp:ListItem>
              </asp:DropDownList>
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" SelectCommand="ProductoXMercadoXPeriodoVal"
              ConnectionString="<%$ ConnectionStrings:ConnPFIZER %>" SelectCommandType="StoredProcedure" >
                <SelectParameters>
        ...
        <td valign="top">
          ...
          <asp:GridView ID="GridView1" AllowSorting="True" AllowPaging="True" runat="server"
            ...
            <Columns>
              ...
              <asp:BoundField DataField="TOTAL" HeaderText="Valores Total Region" SortExpression="TOTAL" DataFormatString="{0:N0}" />
            </Columns>
          ...
          <asp:SqlDataSource ID="SqlDataSource3" runat="server" SelectCommand="ValoresRegionProductoXMercadoTotal"
            ConnectionString="<%$ ConnectionStrings:ConnPFIZER %>" SelectCommandType="StoredProcedure">
            <SelectParameters>
              <asp:ControlParameter ControlID="DropDownList1" Name="mercado" PropertyName="SelectedValue" Type="String" />
              <asp:SessionParameter Name="periodo" SessionField="SesionUsuarioPeriodo" Type="String" />
              <asp:ControlParameter ControlID="DropDownList2" Name="producto" PropertyName="SelectedValue" Type="String" />
            </SelectParameters>
          </asp:SqlDataSource>
        </td>
        ...
        <td valign="top" style="width:250px">
            ...
            <AlternatingRowStyle BackColor="White" />
               <Columns>
                 ...
                 <asp:BoundField DataField="TOTAL" HeaderText="Valores Region X Producto en el Mercado" ReadOnly="True" SortExpression="TOTAL" DataFormatString="{0:N0}" />
               </Columns>
                   <FooterStyle BackColor="#ff9933" />
                  <HeaderStyle BackColor="#ff6600" Font-Bold="True" ForeColor="White" />
                  <PagerStyle BackColor="#ff9933" ForeColor="Black" HorizontalAlign="Right" />
            ...
            <asp:SqlDataSource runat="server" ConnectionString="<%$ ConnectionStrings:ConnPFIZER %>" SelectCommand="ValoresRegionProductoXMercadoPeriodo" ID="SqlDataSource4" SelectCommandType="StoredProcedure">
               <SelectParameters>
                  <asp:ControlParameter ControlID="DropDownList1" Name="mercado" PropertyName="SelectedValue" Type="String" />
                  <asp:SessionParameter Name="periodo" SessionField="SesionUsuarioPeriodo" Type="String" />
                  <asp:ControlParameter ControlID="DropDownList2" Name="producto" PropertyName="SelectedValue" Type="String" />
