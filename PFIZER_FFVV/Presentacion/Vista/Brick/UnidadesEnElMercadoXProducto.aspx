<%@ Page Title="R.E.M.O.T.O." Language="C#" MasterPageFile="~/Presentacion/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="UnidadesEnElMercadoXProducto.aspx.cs" Inherits="PFIZER_FFVV.Presentacion.Vista.Brick.UnidadesEnElMercadoXProducto" %>
...
<fieldset style="width:800px; height:auto; margin-left:15%; left: 200px; position: relative; top: -190px;">
    <legend>Brick/ Unid Mercado X Producto</legend> 
     <table style="top: 0px; position:relative; left: 10px;">
      <tr>
        ...
        <td valign="top">
          ...
          <asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="UnidadesBrickEnElMercadoXProductoTotal"
            ConnectionString="<%$ ConnectionStrings:ConnPFIZER %>" SelectCommandType="StoredProcedure">
            <SelectParameters>
        ...
        <td valign="top" style="width:250px">
            ...
            <AlternatingRowStyle BackColor="White" />
               <Columns>
                 ...
                 <asp:BoundField DataField="TOTAL" HeaderText="Unid Mercado X Producto" ReadOnly="True" SortExpression="TOTAL" DataFormatString="{0:N0}" />
               </Columns>
                   <FooterStyle BackColor="#ff9933" />
                  <HeaderStyle BackColor="#ff6600" Font-Bold="True" ForeColor="White" />
                  <PagerStyle BackColor="#ff9933" ForeColor="Black" HorizontalAlign="Right" />
            ...
            <asp:SqlDataSource runat="server" ConnectionString="<%$ ConnectionStrings:ConnPFIZER %>" SelectCommand="UnidadesBrickEnElMercadoXProductoPeriodo" ID="SqlDataSource3" SelectCommandType="StoredProcedure">
               <SelectParameters>
