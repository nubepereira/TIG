<%@ Page Title="R.E.M.O.T.O." Language="C#" MasterPageFile="~/Presentacion/MasterPage/Site3.Master" AutoEventWireup="true" CodeBehind="ValoresMSXTrimBrickMercadoProducto.aspx.cs" Inherits="PFIZER_FFVV.Presentacion.Vista.Brick.ValoresMSXTrimBrickMercadoProducto" %>
    ...
    <table style="top: 0px; position:relative; left: 10px;">
      <tr>
        ...
        <td valign="top" style="width:250px">
            ...
            HeaderText="Detalle Periodos" ID="GridView2" Width="450px" AutoGenerateColumns="False" AllowPaging="True" style="left: 10px; position: relative; top: 0px; text-align: center;" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" PageSize="100">
            <AlternatingRowStyle BackColor="White" />
               <Columns>
                 <asp:BoundField DataField="MERCADO" HeaderText="Mercado" ReadOnly="True" SortExpression="MERCADO" Visible="false" />
                 ...
                 <asp:BoundField DataField="MS" HeaderText="Unid MS Producto X Mercado" ReadOnly="True" SortExpression="MS" />
               </Columns>
                   <FooterStyle BackColor="#ff9933" />
                  <HeaderStyle BackColor="#ff6600" Font-Bold="True" ForeColor="White" />
                  <PagerStyle BackColor="#ff9933" ForeColor="Black" HorizontalAlign="Right" />
            ...
            <asp:SqlDataSource runat="server" ConnectionString="<%$ ConnectionStrings:ConnPFIZER %>" SelectCommand="ValoresBrickMSXTrimMercadoProductoPeriodo" ID="SqlDataSource3" SelectCommandType="StoredProcedure">
               <SelectParameters>
