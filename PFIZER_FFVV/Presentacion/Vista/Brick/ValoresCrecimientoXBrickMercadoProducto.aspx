<%@ Page Title="R.E.M.O.T.O." Language="C#" MasterPageFile="~/Presentacion/MasterPage/Site3.Master" AutoEventWireup="true" CodeBehind="ValoresCrecimientoXBrickMercadoProducto.aspx.cs" Inherits="PFIZER_FFVV.Presentacion.Vista.Brick.ValoresCrecimientoXBrickMercadoProducto" %>
   ...
   <table style="top: 0px; position:relative; left: 10px;">
      <tr>
        ...
        <td valign="top" style="width:250px">
            ...
            HeaderText="Detalle Periodos" ID="GridView2" Width="510px" AutoGenerateColumns="False" AllowPaging="True" style="left: 15px; position: relative; top: 0px; text-align: center;" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" PageSize="100">
            <AlternatingRowStyle BackColor="White" />
               <Columns>
                 <asp:BoundField DataField="MERCADO" HeaderText="Mercado" ReadOnly="True" SortExpression="MERCADO" Visible="false" />
                 ...
                 <asp:BoundField DataField="CRECIMIENTO" HeaderText="Unid Crec. Mercado X Producto" ReadOnly="True" SortExpression="CRECIMIENTO" />
               </Columns>
                  <FooterStyle BackColor="#ff9933" />
                  <HeaderStyle BackColor="#ff6600" Font-Bold="True" ForeColor="White" />
                  <PagerStyle BackColor="#ff9933" ForeColor="Black" HorizontalAlign="Right" />
            ...
            <asp:SqlDataSource runat="server" ConnectionString="<%$ ConnectionStrings:ConnPFIZER %>" SelectCommand="ValoresBrickCrecXMercadoXProductoPeriodo" ID="SqlDataSource3" SelectCommandType="StoredProcedure">
               <SelectParameters>
