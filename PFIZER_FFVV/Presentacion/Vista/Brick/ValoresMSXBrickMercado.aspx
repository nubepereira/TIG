<%@ Page Title="R.E.M.O.T.O." Language="C#" MasterPageFile="~/Presentacion/MasterPage/Site3.Master" AutoEventWireup="true" CodeBehind="ValoresMSXBrickMercado.aspx.cs" Inherits="PFIZER_FFVV.Presentacion.Vista.Brick.ValoresMSXBrickMercado" %>
...
<fieldset style="width:780px; height:auto; margin-left:15%; left: 200px; position: relative; top: -330px;">
      <legend>Brick/ MS Producto x Brick en el Mercado</legend> 
        ...
        <td valign="top" style="width:250px">
            ...
            <AlternatingRowStyle BackColor="White" />
               <Columns>
                 ...
                 <asp:BoundField DataField="MS" HeaderText="Valores MS Producto X Mercado" ReadOnly="True" SortExpression="MS" />
               </Columns>
                   <FooterStyle BackColor="#ff9933" />
                  <HeaderStyle BackColor="#ff6600" Font-Bold="True" ForeColor="White" />
                  <PagerStyle BackColor="#ff9933" ForeColor="Black" HorizontalAlign="Right" />
            ...
            <asp:SqlDataSource runat="server" ConnectionString="<%$ ConnectionStrings:ConnPFIZER %>" SelectCommand="ValoresBrickMSxMercadoPeriodo" ID="SqlDataSource3" SelectCommandType="StoredProcedure">
               <SelectParameters>
