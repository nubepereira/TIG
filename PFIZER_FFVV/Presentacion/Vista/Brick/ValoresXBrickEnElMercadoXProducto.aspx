<%@ Page Title="R.E.M.O.T.O." Language="C#" MasterPageFile="~/Presentacion/MasterPage/Site3.Master" AutoEventWireup="true" CodeBehind="ValoresXBrickEnElMercadoXProducto.aspx.cs" Inherits="PFIZER_FFVV.Presentacion.Vista.Brick.ValoresXBrickEnElMercadoXProducto" %>
...
<fieldset style="width:750px; height:auto; margin-left:15%; left: 200px; position: relative; top: -190px;">
      <legend>Brick/ % Valores x Brick en el Mercado x Producto</legend> 
    <table style="top: 0px; position:relative; left: 10px;">
      <tr>
        ...
        <td valign="top">
          ...
          <asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="ProductoXMercadoXPeriodoVal"
            ConnectionString="<%$ ConnectionStrings:ConnPFIZER %>" SelectCommandType="StoredProcedure">
            <SelectParameters>
        ...
        <td valign="top" style="width:250px">
            ...
            HeaderText="Detalle Periodos" ID="GridView2" Width="480px" AutoGenerateColumns="False" AllowPaging="True" style="left: 15px; position: relative; top: 0px; text-align: center;" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" PageSize="100">
            <AlternatingRowStyle BackColor="White" />
               <Columns>
                 <asp:BoundField DataField="MERCADO" HeaderText="Mercado" ReadOnly="True" SortExpression="MERCADO" Visible="false" />
                 ...
                 <asp:BoundField DataField="UNIDADES" HeaderText="% Unid Producto X Brick Mercado" ReadOnly="True" SortExpression="UNIDADES" />
               </Columns>
                  <FooterStyle BackColor="#ff9933" />
                  <HeaderStyle BackColor="#ff6600" Font-Bold="True" ForeColor="White" />
                  <PagerStyle BackColor="#ff9933" ForeColor="Black" HorizontalAlign="Right" />
            ...
            <asp:SqlDataSource runat="server" ConnectionString="<%$ ConnectionStrings:ConnPFIZER %>" SelectCommand="ValoresBrickXMercadoXProducto" ID="SqlDataSource3" SelectCommandType="StoredProcedure">
               <SelectParameters>
