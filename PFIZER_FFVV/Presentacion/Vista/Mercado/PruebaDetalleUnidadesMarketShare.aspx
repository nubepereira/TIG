<%@ Page Title="R.E.M.O.T.O" Language="C#" MasterPageFile="~/Presentacion/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="PruebaDetalleUnidadesMarketShare.aspx.cs" Inherits="PFIZER_FFVV.Presentacion.Vista.Mercado.DetalleUnidadesMarketShare" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table style="left: 200px; position: relative">
        ...
        <tr>
            ...
            <td></td>
            <td rowspan="3">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" style="left: 10px; position: relative; text-align: center;" AllowPaging="True" PageSize="12">
                <Columns>
                    ...
                    <asp:BoundField DataField="PRODUCTOS" HeaderText="PRODUCTOS" HeaderStyle-BackColor="#808080" HeaderStyle-ForeColor="White" />
                    <asp:BoundField DataField="PERIODOS" HeaderText="PERIODOS" HeaderStyle-BackColor="#808080" HeaderStyle-ForeColor="White" />
                    <asp:BoundField DataField="MarketShare" DataFormatString="{0:N0}" HeaderText="%MS" HeaderStyle-BackColor="#808080" HeaderStyle-ForeColor="White" />
                </Columns>
                </asp:GridView>
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnPFIZER %>" SelectCommand="MarketShareUnidMercado" SelectCommandType="StoredProcedure">
                    <SelectParameters>
