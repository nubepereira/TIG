<%@ Page Title="R.E.M.O.T.O." Language="C#" MasterPageFile="~/Presentacion/MasterPage/Site3.Master" AutoEventWireup="true" CodeBehind="MercadosVal.aspx.cs" Inherits="PFIZER_FFVV.Presentacion.Vista.Mercado.MercadosVal"%>
    ...
    <table style="border: 1px solid #EEEEEE; left: 450px; position: relative; top: -160px;"> 
        <tr>
            <td class="auto-style21"; style="border: 1px dotted #CCCCCC; padding: 1px 4px; align-content:center;">
                <asp:ImageButton ID="ImageButton4" runat="server" ImageUrl="~/Presentacion/Imagenes/graficoTablas.png" PostBackUrl="~/Presentacion/Vista/Mercado/ValoresVendidosTotalPaisMercado.aspx" style="text-align: center" Height="28px" Width="29px" />
                <br />Valores vendidos total pais del Mercado
            </td>
            <td class="auto-style21"; style="border: 1px dotted #CCCCCC; padding: 1px 4px; align-content:center;">
                <asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="~/Presentacion/Imagenes/graficoTablas.png" PostBackUrl="~/Presentacion/Vista/Mercado/ValoresMSMercado.aspx" style="text-align: center" Height="28px" Width="29px" />
                <br />MS % del Mercado
            </td>
        </tr>
    </table>
